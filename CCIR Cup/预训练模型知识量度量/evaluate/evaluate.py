...
def parse_args():
    ...
    parser.add_argument('data_file', metavar='KCT_train_public.txt', help='Input data file.')  # 数据文件，格式同训练集
    parser.add_argument('pred_file', metavar='pred_answer.csv', help='Model predictions.')  # CSV预测结果文件
